...
const ShowAllRegular = ({ appointments }) => (
  <Card>
    <CardHeader title="Regular Checkups" sx={{ mb: 3 }} />
    <Scrollbar>
    <TableContainer sx={{ minWidth: 720 }}>
        ...
        <TableBody>
            {appointments.map((row, i) => {
                ...
                return (
                  <TableRow key={i}>
                    <TableCell>{row.regularCheckup.split('#')[1]+i}</TableCell>
