...
export default function PatientsList() {
  ...
  const filteredPatients = patients.filter(
    (patient) =>
      !filterName ||
      patient.patientName.toLowerCase().includes(filterName.toLowerCase())
  );
    ...
    <Container maxWidth="lg">
      ...
      <Box display="flex" justifyContent="center" marginBottom={2}>
        <Button
          ...
          onClick={() =>
            fetchData(
              "http://localhost:8080/hospital/show/jasser/getOutPatient"
            )
          }
        >
          Out Patients
        ...
        <Button
          ...
          color="primary"
          onClick={() =>
            fetchData("http://localhost:8080/hospital/show/jasser/getInPatient")
          }
        >
          In Patients
        </Button>
              ...
              {filteredPatients
                ...
                .map((patient) => {
                  const isItemSelected =
                    selected.indexOf(patient.patientName) !== -1;
                    ...
                    >
                      ...
                      <TableCell>
                        {patient.hasMedicalRecord
                          ? patient.hasMedicalRecord.split(",").map((e) => {
                              return (
                                <div style={{ marginBottom: "0.5rem" }}>
                                  <Label variant="ghost" color="success">
                                    {e}
