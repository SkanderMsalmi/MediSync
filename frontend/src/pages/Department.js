...
export default function Department() {
  ...
  const getAllDepartments = () => {
    axios
      .get("http://localhost:8080/hospital/show/adam/getAllDepartments")
      .then((response) => {
  ...
  const filterBySurgicalEquipment = () => {
    axios
      .get(
        "http://localhost:8080/hospital/show/adam/getFilteredDepartmentBySurgicalEquipment"
      )
      .then((response) => {
        // Update the state with the fetched data
        setDepartments(response.data);
  ...
  const filterByImagingEquipment = () => {
    axios
      .get(
        "http://localhost:8080/hospital/show/adam/getFilteredDepartmentByImagingEquipment"
      )
      .then((response) => {
        // Update the state with the fetched data
        setDepartments(response.data);
